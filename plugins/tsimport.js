...
function beforeParse(e) {
  /*
   * Do not process files ending in "loadable.js"
   * to prevent transforming examples showing
   * "loadable" chunks.
   *
   * This is the only modification from the
   * original work.
   *
   * There is likely a better way to do this,
   * but this satisfies the requirements for now.
   */
  if (e.filename.endsWith('loadable.js')) {
    return;
  }
